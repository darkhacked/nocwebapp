...
interface ppp-client add add-default-route=no allow=pap apn=ji.fup dial-on-demand=no disabled=no \
    mrru=1600 name=mino4043a password=123456 phone=*99***1# port=usb1 \
...
ip route add check-gateway=ping comment=AIS-PPTP distance=1 dst-address=172.29.4.0/24 gateway=mino4043a
ip route add check-gateway=ping comment=DTAC-PPTP distance=1 dst-address=172.30.234.0/24 gateway=mino4043a
#
