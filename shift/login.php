	 ...
	 <div class="card shadow-lg bg-white rounded" style="width:600px;">
	      <article class="card-body">
	          <h4 class="card-title text-primary text-center mt-1">NOC JI-NET WORK SCHEDULE</h4>
						<h6 class="card-title text-primary text-center">Version 2.2.0 | <a href="changelog.html" target="_blank"><font color="lightblue">Changelog</font></a></h6>
	          <hr>
	          ...
	          <form method="POST" action="login.php">
						<p><h6><?php echo display_error(); ?></h6></p>
